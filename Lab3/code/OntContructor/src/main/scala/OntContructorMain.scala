...
object OntContructorMain {
  def main(args: Array[String]): Unit = {
    ...
    val classes=Source.fromFile("Abdata/Classes").getLines()
    ...
    val subClasses=Source.fromFile("Abdata/SubClasses").getLines()
    ...
    val objprop=Source.fromFile("Abdata/ObjectProperties").getLines()
    objprop.foreach(f=> {
      val farr=f.split(",")
    ...
    val dataprop=Source.fromFile("Abdata/DataProperties").getLines()
    ...
    val individuals=Source.fromFile("Abdata/Individuals").getLines()
    ...
    val triplets=Source.fromFile("Abdata/Triplets").getLines()
    triplets.foreach(f=>{
      val farr=f.split(",")
    ...
    val os = new FileOutputStream("Abdata/result.owl")
